...
RosPublisher::RosPublisher(const RosPublisherConfig& ros_publisher_config, ros::NodeHandle nh): _config(ros_publisher_config){
  ...
  if(_config.frame_pose){
    ...
    std::function<void(const FramePoseMessageConstPtr&)> publish_frame_pose_function = 
      ...
      outFile.open("/home/jg/pose.txt",std::ios::app);
      if (outFile.is_open()) {
        //outFile<<pose_stamped.header.stamp<<",";
        outFile<<pose_stamped.pose.position.x<<","<<pose_stamped.pose.position.y
                << ","<<pose_stamped.pose.position.z<<",";
        outFile<<pose_stamped.pose.orientation.x<<","<<pose_stamped.pose.orientation.y
      ...
      // std::cout<<pose_stamped.header.stamp<<std::endl;
      // std::cout<<pose_stamped.pose.position.x<<","<<pose_stamped.pose.position.y
      //         << ","<<pose_stamped.pose.position.z<<std::endl;
      // std::cout<<pose_stamped.pose.orientation.x<<","<<pose_stamped.pose.orientation.y
      //         << ","<<pose_stamped.pose.orientation.z<<","<<pose_stamped.pose.orientation.w<<std::endl;
